      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-center">
            <h3 className="text-2xl font-bold text-white">Drop Service Details</h3>
            <p className="text-blue-100 mt-2 max-w-md mx-auto">Book your airport drop service with our reliable and comfortable vehicles</p>
          </div>
