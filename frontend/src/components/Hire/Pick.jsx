      ...
      <div >
        ...
        <form className="space-y-4">
          ...
          <div className="space-y-4">
            <label className="block text-gray-700 font-semibold">Drop the location</label>
            <div className="flex items-center border p-2 rounded-lg bg-gray-50">
              <FaMapMarkerAlt className="text-gray-500 mr-2" />
              <input type="text" className="w-full bg-transparent outline-none" placeholder="Enter Drop Location" />
            </div>
