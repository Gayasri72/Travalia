        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              to creating <span className="text-blue-600 dark:text-blue-400">memories</span>
            </motion.h1>
            ...
            >
              ...
              From breathtaking landscapes to cultural wonders, we've got your perfect journey covered.
            </motion.p>
          ...
          >
            ...
            >
              <div className="text-center p-6">
                ...
                <p className="text-blue-100">Share your travel experiences with fellow adventurers</p>
              </div>
            </motion.div>
          </motion.div>
        </div>
