...
export default function Hires() {
  ...
  return (
    <div className="relative bg-cover bg-center h-screen flex flex-col justify-center items-center text-white px-6"
      style={{ backgroundImage: "url('https://kangaroocabs.com/your-background-image.jpg')" }}>
      
      <h1 className="text-4xl font-bold text-center">Your Journey with Kangaroo Cabs<br /><span className="text-blue-400">Starts Here</span></h1>
      ...
      <div className="mt-6 bg-white text-black p-6 rounded-lg shadow-lg w-full max-w-lg">
        <h2 className="text-xl font-semibold">Select a Vehicle</h2>
        <div className="flex space-x-4 mt-4">
          {vehicles.map((vehicle, index) => (
            <button 
              key={index} 
              className={`py-2 px-4 border rounded-lg ${selectedCar === vehicle ? 'bg-blue-500 text-white' : 'bg-gray-100'}`}
