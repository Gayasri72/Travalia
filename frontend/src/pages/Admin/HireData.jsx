...
const HireData = () => {
  ...
  const handleDeletePickup = async (id) => {
    try {
      setLoading(true);
      await axios.delete(`${API_URL}/pickup/${id}`);
  ...
  const handleDeleteDrop = async (id) => {
    try {
      setLoading(true);
      await axios.delete(`${API_URL}/drop/${id}`);
  ...
  const fetchPickupData = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${API_URL}/pickup`);
      ...
      setError(
        'Failed to fetch pickup data. Please make sure the backend server is running.',
      );
  ...
  const fetchDropData = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${API_URL}/drop`);
      ...
      setError(
        'Failed to fetch drop data. Please make sure the backend server is running.',
      );
